<script>
	...
	import Multiverse from '$lib/slides/03-multiverse.svelte';
	import AtlasOverview from '$lib/slides/04-atlas-overview.svelte';
	import LLMIntroduction from '$lib/slides/05-llm-introduction.svelte';
	import LLMChains from '$lib/slides/06-llm-chains.svelte';
